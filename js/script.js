const global = {
    ...
    api: {
      apiKey:'cbbe593e6cbb6dcce6605228c3f341db',
...
async function searchAPIData() {
  ...
  const response = await fetch(`${API_URL}search/${global.search.type}?api_key=${API_KEY}&en-US&query=${global.search.term}&page=${global.search.page}`);
